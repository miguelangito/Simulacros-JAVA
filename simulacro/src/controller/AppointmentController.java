...
public class AppointmentController {
    ...
    public static void update() {
        Object[] options = Utils.listToArray(instanceModel().listAll());
        Appointment appointmentSelected = (Appointment) JOptionPane.showInputDialog(null, "Select the Appointment to update", "", JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
